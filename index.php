...
// No need to require HashIdHelper here unless used globally, but good practice if needed later.
...
$router->post('/login', __DIR__ . '/modules/auth/login.php'); // Handle login post
$router->get('/logout', __DIR__ . '/modules/auth/logout.php');

// --- Dashboard ---
$router->get('/dashboard', __DIR__ . '/modules/dashboard/index.php');
$router->get('/home', __DIR__ . '/modules/dashboard/index.php'); // Alias
...
$router->get('/accounts/delete', __DIR__ . '/modules/accounts/delete.php'); // Usually expects ?id=...
...
// --- Journal, Cash, Reports, Logs (Mapping index for now, add others as needed) ---
